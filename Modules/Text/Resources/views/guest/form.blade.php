...
@section('title')
{!! mb_strtoupper($s_text_action . ' &#60; ' . trans(request()->segment(1) . '::crud.names.plr')) !!}
@endsection

@include('public.partials._profile', ['s_id' => '#addtext-form'])
...
@section('content')
        ...
        <div class="map_info_block">
            <div id="map_search" style="display:none;">
                <input type="text" textholder="Поиск" name="s" />
            ...
            <div id="mib_content" class="visible_anytime">
                <div class="new_text_wrap">
					...
					<form action="{!! route('api.'.$s_category.'.store') !!}" method="POST" class="form-text item-form" id="create-{!! $s_category !!}-form">
						@csrf
...
{{--
							...
							<div class="user_fields">
								...
								<div class="item">
									...
									<span class="value">
										<input type="email" class="form-control"  textholder="" name="email">
									</span>
								</div>
...
@include($theme . '::' . $_env->s_utype . '._recaptcha', ['id' => 'create-' . $s_category])
							...
							<div class="buttons">
								<button type="submit" class="confirm">{!! trans('personal::guest.button.add_new_text') !!}</button>
							</div>
						</form>
--}}
@append
