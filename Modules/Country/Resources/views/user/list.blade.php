					...
					$.ajax({
						...
						success: function (data, status, xhr){
							...
							if (xhr.status === 200) {
								...
								// 1) proper rows selection when holding "shift" button otherwise datatable "remembers" the rows order when table was filled at country open and selecting consecutive rows looks a bit cont-intuitive
